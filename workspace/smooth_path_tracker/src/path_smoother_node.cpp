...
public:
    PathSmootherNode() : Node("path_smoother_node") {
        ...
        path_publisher_ = this->create_publisher<nav_msgs::msg::Path>("/smooth_path", qos_profile);
        marker_publisher_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("/waypoint_markers", qos_profile);
